			...
			<div className="py-20 bg-white lg:px-4 container px-0 mx-auto gap-6 flex flex-col lg:flex-row items-center lg:items-start justify-between">
				<div className="w-full px-4 lg:mb-0 lg:w-1/2">
					<motion.h2
						...
						viewport={{once: true}}
						className="lg:max-w-lg mb-6 text-center lg:text-left font-semibold leading-tight text-lg lg:text-xl text-black"
					>
						{title}
					</motion.h2>
					<Paragraph
				...
				>
					...
					>
						...
						>
							<div className="flex items-center justify-center w-8 h-8 rounded-full bg-primary-two sm:mr-3">
								<svg
									fill="#ffffff"
									width="800px"
									height="800px"
